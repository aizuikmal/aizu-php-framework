    ...
    class ezSQLcore
    {
        ...
        */
        ...
        function debug($print_to_screen=true)
        {
            ...
            // {
            //     echo "============================ Results retrieved from disk cache ============================";
            // }
        ...
        function debug_html($print_to_screen=true)
        {
        ...
        */
        ...
        function query($query)
        {
            ...
            if ( $str = @$this->dbh->error )
            {
                ...
                //$this->show_errors ? trigger_error($str,E_USER_WARNING) : null;   //20160131 - aizu remove this
                return false;
            }
